...
if get_response.status_code == 200:
    ...
    get_response2 = requests.post(endpoint, json=data1, headers=headers)

    print(get_response2.status_code)
    print(get_response2.json())

if get_response2.status_code == 401:
    ...
    if refresh_response.status_code == 200:
        ...
        get_response2 = requests.post(endpoint, json=data, headers=headers)
